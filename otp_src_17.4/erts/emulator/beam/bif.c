...
/*
 * Erlang ‘！’和send_2均会调用erl_send函数
 *
 */
Eterm erl_send(Process *p, Eterm to, Eterm msg)
{
	/*关于Data types可以参考sys.h文件*/
    Eterm ref;
    Sint result;
...
#endif
	/*
	 * 调用do_send函数发送消息，返回发送结果；大于0表示本次发送消息操作
	 * 需要扣除reductions，其他结果表示错误码
	 */
