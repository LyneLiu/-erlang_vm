...
const char* erts_build_flags_CFLAGS = "-Werror=return-type  -g -O2 -I/root/Public/otp_src_17.4/erts/i686-pc-linux-gnu  -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -fno-tree-copyrename  -D_GNU_SOURCE  -DHAVE_CONFIG_H -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS  ";
const char* erts_build_flags_CONFIG_H = "/* i686-pc-linux-gnu/config.h.  Generated by configure.  */\n\
...
#define ERTS_EMU_CMDLINE_FLAGS \" -g -O2 -I/root/Public/otp_src_17.4/erts/i686-pc-linux-gnu  -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -fno-tree-copyrename  -D_GNU_SOURCE -g  -D_GNU_SOURCE -I/root/Public/otp_src_17.4/erts/i686-pc-linux-gnu   -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -DUSE_THREADS -D_THREAD_SAFE -D_REENTRANT -DPOSIX_THREADS -D_POSIX_THREAD_SAFE_FUNCTIONS  -Werror=return-type  -Wall -Wstrict-prototypes -Wmissing-prototypes -Wdeclaration-after-statement\"\n\
\n\
